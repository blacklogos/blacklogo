...
```bash
/cm:plan "Q2 Planerio 2.0 Launch" --budget 50000 --duration "6 weeks" --goal "500 trial signups" --audience "Startup Sam, Manager Maria" --channels "paid search, LinkedIn, content marketing"
```
